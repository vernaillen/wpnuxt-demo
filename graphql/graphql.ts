...
export type GeneralSettings = {
  ...
  /** Een datum formaat voor alle datum strings. */
  dateFormat?: Maybe<Scalars['String']['output']>;
  /** Site slogan. */
  description?: Maybe<Scalars['String']['output']>;
  /** Dit adres word gebruikt voor administratieve doeleinden, zoals meldingen voor nieuwe gebruikers. */
  email?: Maybe<Scalars['String']['output']>;
  /** WordPress locale code. */
  language?: Maybe<Scalars['String']['output']>;
  /** Nummer van de dag waarop de week zou moeten beginnen. */
  startOfWeek?: Maybe<Scalars['Int']['output']>;
  /** Een tijd format voor alle tijd strings. */
  timeFormat?: Maybe<Scalars['String']['output']>;
  /** Een stad in dezelfde tijdzone waar u bent. */
...
export type ReadingSettings = {
  ...
  /** Het ID van de pagina die op de startpagina moet worden weergegeven */
  pageOnFront?: Maybe<Scalars['Int']['output']>;
  /** Blog pagina&#039;s tonen hoogstens. */
  postsPerPage?: Maybe<Scalars['Int']['output']>;
  /** Wat te tonen op de startpagina */
...
/** The template assigned to the node */
export type Template_Blanco = ContentTemplate & {
  __typename?: 'Template_Blanco';
  /** The name of the template */
  templateName?: Maybe<Scalars['String']['output']>;
};

/** The template assigned to the node */
export type Template_Blogalternatief = ContentTemplate & {
  __typename?: 'Template_Blogalternatief';
  /** The name of the template */
  templateName?: Maybe<Scalars['String']['output']>;
};
...
export type UpdateSettingsInput = {
  ...
  /** Standaard berichtformat. */
  writingSettingsDefaultPostFormat?: InputMaybe<Scalars['String']['input']>;
  /** Zet emoticons zoals :-) en :-P bij vertonen om in afbeeldingen. */
